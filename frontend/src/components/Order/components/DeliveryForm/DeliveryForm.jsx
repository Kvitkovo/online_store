...
const DeliverForm = ({ state }) => {
  const initState = state;

  const [showShopList, setShowShopList] = useState(true);
  const [showDeliveryForm, setShowDeliveryForm] = useState(false);
  const [hideFormDelivery, setHideFormDelivery] = useState(initState);
  ...
  const onSubmit = (data) => {
    ...
    setHideFormDelivery(false);
    // console.log('hideFormDelivery from DeliveryForm: ', hideFormDelivery);
  };

  const handleChangeDelivery = () => {
    setHideFormDelivery(!hideFormDelivery);
    // console.log('from handleChangeDelivery');
  };
  ...
  return (
    <>
      {!hideFormDelivery && (
        <ChangeDataBtn
          sectionState={hideFormDelivery}
          handleChangeData={handleChangeDelivery}
        />
      )}
      {!hideFormDelivery && (
